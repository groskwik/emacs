...
(setq dired-guess-shell-alist-user
      '(("\\.pdf\\'" "okular ? &" "evince ? &" "inkscape ? &")
        ...
        ("\\.txt\\'" "nedit ? &" "gedit ? &" "gvim ? &" )
        ("\\.csv\\'" "nedit ? &" "gedit ? &" "gvim ? &" )
        ("\\.dat\\'" "nedit ? &" "gedit ? &" "gvim ? &" )
        ("\\.inp\\'" "nedit ? &" "gedit ? &" "gvim ? &" )
        ("\\.f\\'" "nedit ? &" "gedit ? &" "gvim ? &" )
        ("\\.f90\\'" "nedit ? &" "gedit ? &" "gvim ? &" )
        ("\\.c\\'" "nedit ? &" "gedit ? &" "gvim ? &" )
        ("\\.cpp\\'" "nedit ? &" "gedit ? &" "gvim ? &")
        ("\\.plt\\'" "nedit ? &" "gedit ? &" "gvim ? &")
        ("\\.gp\\'" "nedit ? &" "gedit ? &" "gvim ? &")))
...
(setq default-frame-alist
      '((top . 65) (left . 200) (width . 120) (height . 35)))
...
(setq user-mail-address "groskwik@gmail.com"
      user-full-name "Benoit Dulauroy")
